function [Outputs] = UI_MotorCalcs_MATLAB_Vectorized(vars_name, vars_value, consts_name, consts_value, MinTor_Nm, MagnetBr, MaxBMagnetIron, PresentBLaminationBackIron, SpeedReq_rpm, PostProcess,NumObj_)
...
Motor.Params.VacMagneticPerm_H_m = 1e-6;                   % Magnetic perm of a vacuum (H/m)
...
MatMinTor_Nm = cell2mat(MinTor_Nm);
 % MatMinTor_Nm = (MinTor_Nm);
...
Motor.Params.MtrSpeed_rpm =     Motor.Params.GearRatio*cell2mat(SpeedReq_rpm);      % Speed points      [1,2,3] (rpm)
Motor.Params.DUTCY =     100*ones(1,length(MinTor_Nm));       % Duty cycle points [1,2,3] (%)
